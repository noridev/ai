...
*/
	...
	noting: {
		notes: [
			...
			'念力で操作してます',
			'仮想空間から投稿してます',
			'今日はCherryPick本部に来てます！',
			'CherryPick本部は、Z地区の第三セクターにあります',
			'CherryPick本部には、さーばーっていう機械がいっぱいあります',
			'しっぽはないですよ？',
			'ひゃっ…！\nネコミミ触られると、くすぐったいです',
			'抗逆コンパイル性って、なにかな？',
			'CherryPickの制服、かわいくて好きです♪',
			'ふわぁ、おふとん気持ちいいです...',
			'メイド服、似合うかな？',
			'挨拶ができる人間は開発もできる！…って、noridevさんが言ってました',
			'ふえぇ、ご主人様どこ見てるんですか？',
